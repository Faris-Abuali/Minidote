...
defmodule TestSetup do
  ...
  @spec stop_node(atom, boolean()) :: :ok
  def stop_node(node, clear_log \\ true) do
  ...
  @spec stop_nodes([atom], boolean()) :: :ok
  def stop_nodes(nodes, clear_log) do
    Enum.each(nodes, fn node ->
      stop_node(node, clear_log)
    end)
